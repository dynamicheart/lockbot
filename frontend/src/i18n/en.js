export default {
  ...
  botCreate: {
    ...
    trustedOperatorIdsPlaceholder: 'Enter IM user_ids, separated by commas',
  ...
  admin: {
    ...
    restoreFileHint:
      'Select a LockBot full backup zip file. Preview only; no restore will be applied yet.',
    restorePasswordHint: 'Backup password (if any)',
    restoreSourceKeyHint: 'Source instance Secret Key (if from another instance)',
    restoreSourceKeyExplain:
      'If the backup is from another instance, provide its LOCKBOT_SECRET_KEY to restore webhook/token credentials. Leave empty to skip credential restore; you will need to reconfigure them manually after import.',
    previewRestore: 'Preview Restore',
    confirmRestore: 'Confirm Restore',
    reselect: 'Reselect',
    restoreAction: 'Action',
    restoreAction_create: 'Create',
    restoreAction_overwrite: 'Overwrite',
    restoreAction_skip: 'Skip',
    restoreOwnerCurrent: 'Current User',
    credentialsOk: 'Credentials OK',
    backupPasswordRequired: 'This backup is encrypted. Please enter the backup password.',
    backupPasswordWrong: 'Incorrect backup password. Please try again.',
    restore_credentials_all_ok: 'Credentials decrypted successfully. Full restore available.',
    restore_credentials_no_key:
      "{count} bot(s) have credentials encrypted with a different key. Provide the source instance's Secret Key, or reconfigure webhook/token after restore.",
    restore_credentials_key_wrong: 'Key mismatch: {count} bot(s) credentials cannot be decrypted',
    restore_unrecognized_format: 'Unrecognized backup format: {format}',
    stateStatus: 'State',
    stateNone: 'None',
    stateWarning: 'Warning',
    stateOk: 'OK',
    restoreSuccess: 'Restore complete: {created} created, {overwritten} overwritten',
    botCount: 'Total Bots',
  ...
  backup: {
    ...
    bosEndpointPlaceholder: 'e.g. bj.bcebos.com',
    bosBucket: 'Bucket',
    bosBucketPlaceholder: 'Bucket name',
    bosPrefix: 'Path Prefix',
    bosPrefixPlaceholder: 'e.g. lockbot/backups/',
    zipPassword: 'Archive Password',
    zipPasswordPlaceholder: 'Optional, leave empty for no encryption',
    ...
    weekday7: 'Sun',
    dayUnit: 'th',
    saveFirst: 'Please save settings first',
  ...
  botForm: {
    ...
    nodeName: 'Node Name',
    nodeNamePlaceholder: 'e.g. node0 (case-insensitive)',
