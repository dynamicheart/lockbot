export default {
  ...
  botCreate: {
    ...
    trustedOperatorIdsPlaceholder: '输入 IM user_id，多个用逗号分隔',
    language: '机器人回复语言',
    langZh: '中文',
    langEn: 'English',
  ...
  admin: {
    ...
    restoreFileHint: '请选择 LockBot 完整备份 zip 文件，仅用于预览，不会立即恢复。',
    restorePasswordHint: '备份密码（如有）',
    restoreSourceKeyHint: '源实例 Secret Key（如来自其他实例）',
    restoreSourceKeyExplain:
      '如果备份来自其他实例，提供源实例的 LOCKBOT_SECRET_KEY 可恢复 webhook/token 等凭证。不填则跳过凭证恢复，导入后需手动重新配置。',
    previewRestore: '预览恢复',
    confirmRestore: '确认恢复',
    reselect: '重新选择',
    restoreAction: '恢复方式',
    restoreAction_create: '新建',
    restoreAction_overwrite: '覆盖',
    restoreAction_skip: '跳过',
    restoreOwnerCurrent: '当前用户',
    credentialsOk: '密钥可用',
    backupPasswordRequired: '该备份文件已加密，请输入备份密码',
    backupPasswordWrong: '备份密码错误，请重新输入',
    restore_credentials_all_ok: '凭证解密成功，可完整恢复',
    restore_credentials_no_key:
      '{count} 个机器人的凭证无法解密（加密密钥不同）。请提供源实例的 Secret Key，或恢复后手动重新配置。',
    restore_credentials_key_wrong: '密钥不匹配，{count} 个机器人凭证无法解密',
    restore_unrecognized_format: '无法识别的备份格式: {format}',
    stateStatus: '状态文件',
    stateNone: '无',
    stateWarning: '有问题',
    stateOk: '正常',
    restoreSuccess: '恢复完成：新建 {created} 个，覆盖 {overwritten} 个',
    botCount: '机器人总数',
    runningCount: '运行中',
    siteSettings: '站点设置',
  ...
  backup: {
    ...
    bosEndpointPlaceholder: '例如 bj.bcebos.com',
    bosBucket: 'Bucket',
    bosBucketPlaceholder: 'bucket 名称',
    bosPrefix: '路径前缀',
    bosPrefixPlaceholder: '例如 lockbot/backups/',
    zipPassword: '压缩密码',
    zipPasswordPlaceholder: '可选，为空则不加密',
    frequency: '备份频率',
    daily: '每天',
    weekly: '每周',
    monthly: '每月',
  ...
  botForm: {
    ...
    nodeName: '节点名称',
    nodeNamePlaceholder: '例如 node0（不区分大小写）',
    addDevice: '添加设备',
    quickAdd: '快捷:',
    copyNode: '复制',
