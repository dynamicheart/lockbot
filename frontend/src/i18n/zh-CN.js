export default {
  ...
  botCreate: {
    ...
    credFieldHints: {
      ...
      Feishu: {
        webhookUrl: 'App ID，在飞书开放平台应用详情页的「凭证与基础信息」中获取',
        token: 'App Secret，在飞书开放平台应用详情页的「凭证与基础信息」中获取',
        aesKey: 'Encrypt Key（可选），在「开发配置 → 事件与回调 → 加密策略」中设置；留空则不加密',
        hintTitle: '如何获取凭证信息？',
        step1: '1. 在飞书开放平台创建自建应用，开启「机器人」功能',
        step2:
          '2. 在「开发配置 → 事件与回调」中填写本机器人的回调地址，订阅 im.message.receive_v1 事件',
        step3: '3. 将 App ID、App Secret 填入下方；如需加密可配置 Encrypt Key',
      },
    },
    optional: '可选',
    ...
    webhookHelpStep1: '1. 在 IM 平台创建机器人应用',
