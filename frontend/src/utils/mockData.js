...
export const mockBots = [
  // ── demo_user (id 1, super_admin) ──
  {
    ...
    cluster_configs: JSON.stringify([
      { node_key: 'node1', devices: ['A100', 'A100', 'H100'] },
      { node_key: 'node2', devices: ['A100'] },
    ]),
  ...
  },
  {
    ...
    status: 'stopped',
    last_request_at: null,
    cluster_configs: JSON.stringify([{ node_key: 'dev-node', devices: ['V100', 'V100'] }]),
    config_overrides: null,
    created_at: now,
    updated_at: now,
  },
  // ── researcher (id 5, admin) ──
  {
    ...
    last_request_at: null,
    cluster_configs: JSON.stringify([
      { node_key: 'srv-a', devices: ['H20', 'H20', 'A100', 'A100'] },
      { node_key: 'srv-b', devices: ['H100', 'H100', 'A100'] },
    ]),
    config_overrides: JSON.stringify({ LANGUAGE: 'en' }),
    created_at: now,
    updated_at: now,
...
export const mockAuditLogs = [
  ...
  },
  {
    ...
    target_type: 'bot',
    target_id: 2,
    target_name: 'node-bot-02',
    detail: null,
    result: 'success',
    ip_address: '127.0.0.1',
    created_at: _ago(300),
  },
  // Anonymous failed login attempts targeting user1's account (from external IP)
  {
    id: 16,
    operator_id: null,
    operator_username: 'user1',
