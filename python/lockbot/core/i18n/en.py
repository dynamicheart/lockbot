...
MESSAGES = {
    ...
    "help.lock_all_devices_example": "    lock {node}\n",
    "help.lock_device_example": "    lock {node} dev0\n",
    "help.lock_device_duration_example": "    lock {node} dev0 2h\n",
    "help.lock_device_range_example": "    lock {node} dev0-3\n",
    "help.slock_device_range_example": "    slock {node} dev0-3 2h\n",
    "help.unlock_device_example": "    unlock {node}\n",
    "help.unlock_device_range_example": "    unlock {node} dev0-3\n",
    "help.free_device_range_example": "    free {node} dev0-3\n",
    "help.free_node_all_example": "    free {node}\n",
    "help.kickout_device_example": "    kickout {node}\n",
    "help.kickout_device_range_example": "    kickout {node} dev0-3\n",
    "help.kickout_device_range2_example": "    kickout {node} dev0\n",
    ...
    # ── Alias command ──
    "alias.help_section": "{num}. Alias: alias {node} <label>\n   Clear: alias {node}\n",
